            ...
            <li class="nav-item active">
                ...
                <div id="collapsePembelian" class="collapse" aria-labelledby="headingPembelian" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('/superadmin/pembelian/create') }}">Catat Transaksi</a>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 text-left font-weight-bold">Catat Transaksi Pembelian</h1>
    </div>
            ...
            <form id="headerForm" onsubmit="return false;">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="kode_transaksi" name="kode_transaksi" value="TRX{{ date('YmdHis') }}" readonly>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="catatan_transaksi" name="catatan_transaksi" placeholder="Catatan tambahan...">
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Box Total Bayar -->
                    <div class="mt-3 p-3" style="background-color: #EBF2E8; font-weight:bold; text-align:right; font-size:2rem; color: #333333;">
                        Total Bayar: <span id="totalBayar">Rp 0,-</span>
                    </div>

                    <!-- Tombol Simpan & Reset -->
                    <div class="mt-3 text-right">
                        <button class="btn btn-primary" id="btnSimpan" type="button">
