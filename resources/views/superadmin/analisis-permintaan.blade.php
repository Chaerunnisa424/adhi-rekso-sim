...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Prediksi Permintaan Produk</h1>
    ...
    <div class="card shadow mb-4 card-header-transaksi">
        <div class="card-body">
            ...
            <h5 class="font-weight-bold mb-3 text-primary">
                <i class="fas fa-filter mr-1"></i> Filter Prediksi
            </h5>

            <form id="filterPrediksiForm">
                ...
                <div class="form-row d-flex align-items-end">
                    ...
                    <!-- Musim Tanam -->
                    <div class="form-group col-md-2">
                        <label for="musim_tanam">Musim Tanam (MT)</label>
                        <select class="form-control" id="musim_tanam">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="produk" class="form-control select2">
                            ...
                            <option>Pupuk B</option>
                            <option>Pestisida C</option>
                            <option>Benih D</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        <button class="btn btn-primary btn-block">
                            <i class="fas fa-chart-line mr-1"></i> Prediksi
                        </button>
                    </div>
    ...
    <div class="card shadow mb-4 mt-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="font-weight-bold m-0" style="color:#609966;">Hasil Prediksi Permintaan</h6>
