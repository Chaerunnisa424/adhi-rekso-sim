            ...
            <li class="nav-item active">
                ...
                <div id="collapseLaporan" class="collapse" aria-labelledby="headingLaporan" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('/superadmin/laporan/LaporanPengeluaran') }}">Laporan Pengeluaran</a>
                    </div>
                </div>
            </li>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Laporan Pengeluaran</h1>
    ...
    <div class="card shadow mb-4 card-header-transaksi">
        <div class="card-body">
            ...
            <h5 class="font-weight-bold mb-3 text-primary">
                <i class="fas fa-filter mr-1"></i> Filter Laporan Pengeluaran
            </h5>

            <form id="filterPengeluaranForm">
                <div class="form-row">
...
<div class="row">
        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="h5 font-weight-bold text-gray-800">Rp 187,400,000</div>
                </div>
        ...
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="h5 font-weight-bold text-gray-800">126 Transaksi</div>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kategori Terbesar</div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Rata-rata Harian</div>
                    <div class="h5 font-weight-bold text-gray-800">Rp 750,000</div>
                </div>
    ...
    <div class="row d-flex align-items-stretch mb-4">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow card-line-chart">
                <div class="card-header">
                    <h6 class="font-weight-bold m-0" style="color:#609966;">Tren Pengeluaran Bulanan (2025)</h6>
                </div>
                <div class="card-body">
        ...
        <!-- Grafik Batang Pengeluaran per Kategori -->
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow h-80">
                <div class="card-header">
                    <h6 class="font-weight-bold m-0" style="color:#609966;">Pengeluaran Berdasarkan Kategori</h6>
                </div>
                <div class="card-body">
    ...
    <div class="card shadow mb-4 mt-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="font-weight-bold m-0" style="color:#609966;">Daftar Transaksi Pengeluaran</h6>
...
<!-- ==================================================================================================================================================  -->
    ...
    <script src="{{ asset('js/superadmin/laporan_pengeluaran.js') }}"></script>
