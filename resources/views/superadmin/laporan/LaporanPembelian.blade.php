...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Laporan Pembelian</h1>
   ...
   <!-- FILTER LAPORAN - Mengikuti Style Header Transaksi -->
        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="h5 font-weight-bold text-gray-800">Rp 125,500,000</div>
                </div>

                <!-- Bulat, warna sesuai border card, icon putih -->
        ...
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="h5 font-weight-bold text-gray-800">152 Transaksi</div>
                </div>
   ...
   <!-- Supplier Aktif -->
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Supplier Aktif</div>
                    <div class="h5 font-weight-bold text-gray-800">12 Supplier</div>
                </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Item Dibeli</div>
                    <div class="h5 font-weight-bold text-gray-800">3,550 Item</div>
                </div>
...
<!-- Grafik Row -->
<div class="row d-flex align-items-stretch mb-4"> <!-- tambah mb-4 -->

    <!-- Tren Pembelian (Line Chart) -->
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow card-line-chart">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="font-weight-bold text-primary m-0">Tren Pembelian Bulanan (2025)</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow h-80">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="font-weight-bold text-primary m-0">Top 5 Supplier</h6>
            </div>

            <div class="card-body">

                <style>
                    .supplier-item { margin-bottom: 18px; }
                    .supplier-name { font-weight: 600; color: #333; display: block; }
                    .progress-bar-custom {
                        width: 100%;
                        height: 10px;
                        background: #eaeaea;
                ...
                <div class="supplier-item">
                    ...
                    <div class="progress-bar-custom">
                        <div class="progress-fill" style="width: 90%; background-color:#40513B;"></div>
                    </div>
                    <span class="supplier-value">Rp. 10.560.000</span>
                </div>

                <div class="supplier-item">
                    <span class="supplier-name">Supplier B</span>
                    <div class="progress-bar-custom">
                        <div class="progress-fill" style="width: 85%; background-color:#506649;"></div>
                    </div>
                    <span class="supplier-value">Rp. 9.900.000</span>
                </div>

                <div class="supplier-item">
                    <span class="supplier-name">Supplier C</span>
                    <div class="progress-bar-custom">
                        <div class="progress-fill" style="width: 75%; background-color:#558049;"></div>
                    </div>
                    <span class="supplier-value">Rp. 9.220.000</span>
                </div>

                <div class="supplier-item">
                    <span class="supplier-name">Supplier D</span>
                    <div class="progress-bar-custom">
                        <div class="progress-fill" style="width: 65%; background-color:#9DC08B;"></div>
                    </div>
                    <span class="supplier-value">Rp. 8.400.000</span>
                </div>

                <div class="supplier-item">
                    <span class="supplier-name">Supplier E</span>
                    <div class="progress-bar-custom">
                        <div class="progress-fill" style="width: 55%; background-color:#B0CE88;"></div>
                    </div>
                    <span class="supplier-value">Rp. 7.100.000</span>
                </div>
...
<!-- Tabel dengan jarak besar dari grafik -->
<div class="card shadow mb-4 mt-4"> <!-- tambah mt-4 -->
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h6 class="font-weight-bold text-primary m-0">Riwayat Pembelian</h6>
...
<!-- ==================================================================================================================================================  -->
    ...
    <script src="{{ asset('js/superadmin/laporan_pembelian.js') }}"></script>
