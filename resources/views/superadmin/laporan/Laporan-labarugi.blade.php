    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('/superadmi/laporan/laporan-labarugi') }}">
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Laporan Laba & Rugi</h1>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Pembelian (HPP)</div>
                        <div class="h5 font-weight-bold text-gray-800">Rp 145,000,000</div>
                    </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kategori Pengeluaran Terbesar</div>
                        <div class="h5 font-weight-bold text-gray-800">Gaji Karyawan</div>
                    </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Laba Bersih</div>
                        <div class="h5 font-weight-bold text-gray-800">Rp 72,000,000</div>
                    </div>
    ...
    <div class="row d-flex align-items-stretch mb-4">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow card-line-chart">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="font-weight-bold text-primary m-0">Tren Laba Bersih Bulanan</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow h-80">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="font-weight-bold text-primary m-0">Proporsi Penjualan per Kategori Produk</h6>
                </div>
    ...
    <!-- Grafik Bar + Produk Laba Tertinggi -->
    <div class="row mb-4">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary m-0">Perbandingan Penjualan, Pembelian, Pengeluaran</h6>
                </div>
                <div class="card-body">
        ...
        <!-- Produk Kontribusi Laba Tertinggi -->
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow h-80">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary m-0">Produk Dengan Kontribusi Laba Tertinggi</h6>
                </div>
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between">
                            Produk A <span class="font-weight-bold text-success">Rp 25,000,000</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            Produk B <span class="font-weight-bold text-success">Rp 18,700,000</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            Produk C <span class="font-weight-bold text-success">Rp 12,200,000</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="card shadow mb-4 mt-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="font-weight-bold text-primary m-0">Rincian Laba Rugi</h6>
