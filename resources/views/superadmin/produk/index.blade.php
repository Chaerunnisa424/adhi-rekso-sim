...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('superadmin.produk.create') }}" class="btn btn-primary btn-sm shadow-sm">
            <i class="fas fa-plus fa-sm mr-2"></i> Tambah Produk
        </a>
    </div>

    <!-- Card Tabel Data Produk -->
                   ...
                   <tbody>
                    @forelse ($produk as $item)
                       ...
                       <td class="text-left">
                            ...
                            <!-- Tombol Edit -->
                            <a href="{{ route('superadmin.produk.edit', $item->id_produk) }}"
                            ...
                            <!-- Form Hapus -->
                            <form id="formHapus-{{ $item->id_produk }}"
                                action="{{ route('superadmin.produk.destroy', $item->id_produk) }}"
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                ...
                // 🔥 Setelah menekan OK → submit form hapus
