...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 text-left">
            <i class="fas fa-edit mr-2"></i> Edit Data Produk
        </h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-left">
                <i class="fas fa-clipboard-list mr-2"></i> Form Edit Produk
            </h6>
        </div>
        ...
        <div class="card-body">
            ...
            <!-- Form Update -->
            <form action="{{ route('superadmin.produk.update', $produk->id_produk) }}" method="POST">
                @csrf
                @method('POST') <!-- karena route update kamu pakai POST -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="satuan" class="form-control" required>
                            ...
                            @foreach (['Kg', 'Botol', 'Karung', 'Pcs'] as $s)
                                <option value="{{ $s }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="stok_minimum" class="form-control"
                               value="{{ old('stok_minimum', $produk->stok_minimum) }}" required>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('superadmin.produk.index') }}" class="btn btn-secondary ml-2">
