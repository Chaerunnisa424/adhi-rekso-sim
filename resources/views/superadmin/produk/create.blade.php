        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseLaporan" class="collapse" aria-labelledby="headingLaporan" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('/superadmin/LaporanPembelian') }}">Laporan Pembelian</a>
                        <a class="collapse-item" href="{{ url('/superadmin/LaporanPenjualan') }}">Laporan Penjualan</a>
                        <a class="collapse-item" href="{{ url('/superadmin/LaporanPengeluaran') }}">Laporan Pengeluaran</a>
                    </div>
                </div>
            </li>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 text-left">
            <i class="fas fa-box-open mr-2"></i> Tambah Data Produk
        </h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-left">
                <i class="fas fa-clipboard-list mr-2"></i> Form Input Produk
            </h6>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('superadmin.produk.store') }}" method="POST">
                @csrf

                <div class="row">
                    <!-- Nama Produk -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-tag mr-1 text-primary"></i> Nama Produk</label>
                    ...
                    <!-- Kode Produk -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-barcode mr-1 text-primary"></i> Kode Produk</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-list mr-1 text-primary"></i> Kategori</label>
                    ...
                    <!-- Satuan -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-balance-scale mr-1 text-primary"></i> Satuan</label>
                        <select name="satuan" class="form-control" required>
                            <option value="" disabled selected>Pilih satuan</option>

                            <option {{ old('satuan') == 'Kg' ? 'selected' : '' }}>Kg</option>
                            <option {{ old('satuan') == 'Botol' ? 'selected' : '' }}>Botol</option>
                            <option {{ old('satuan') == 'Karung' ? 'selected' : '' }}>Karung</option>
                            <option {{ old('satuan') == 'Pcs' ? 'selected' : '' }}>Pcs</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <!-- Harga Beli -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-money-bill-wave mr-1 text-primary"></i> Harga Beli (Rp)</label>
                    ...
                    <!-- Harga Jual -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-tags mr-1 text-primary"></i> Harga Jual (Rp)</label>
                ...
                <div class="row">
                    <!-- Stok -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-boxes mr-1 text-primary"></i> Stok</label>
                    ...
                    <!-- Stok Minimum -->
                    <div class="col-md-6 mb-3">
                        <label><i class="fas fa-exclamation-triangle mr-1 text-primary"></i> Stok Minimum</label>
                ...
                <div class="mt-4">
                    ...
                    <button type="reset" class="btn btn-warning ml-2 text-white">
...
function hapusProduk() {
  Swal.fire({
    ...
    customClass: {
      ...
      cancelButton: 'btn btn-cancel mx-2 swal-btn'
    },
