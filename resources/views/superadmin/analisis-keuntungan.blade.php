...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Laporan Keuntungan Produk</h1>
...
<div class="card shadow mb-4 card-header-transaksi">
    <div class="card-body">
        ...
        <h5 class="font-weight-bold mb-3 text-primary">
            <i class="fas fa-filter mr-1"></i> Filter Keuntungan Produk
        </h5>

        <form id="filterKeuntunganForm">
            ...
            <div class="form-row d-flex align-items-end">
                ...
                <!-- Tanggal Sampai -->
                <div class="form-group col-md-2">
                    <label for="endDate">Tanggal Sampai</label>
                    <input type="date" class="form-control" id="endDate">
                </div>

                <!-- Urutkan -->
                <div class="form-group col-md-2">
                    <label for="sortKeuntungan">Urutkan</label>
                    <select class="form-control" id="sortKeuntungan">
                        <option value="desc">Keuntungan Tertinggi</option>
                        <option value="asc">Keuntungan Terendah</option>
                    </select>
                </div>

                <!-- Produk Search -->
                <div class="form-group col-md-4">
                    <label for="produkSearch">Cari Produk</label>
                    <select class="form-control select2" id="produkSearch">
                        <option value="">Semua Produk</option>
                        <option>Pupuk A</option>
                        <option>Pestisida B</option>
                        <option>Benih C</option>
                    </select>
                </div>
    ...
    <!-- TABEL KEUNTUNGAN PRODUK -->
    <div class="card shadow mb-4 mt-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="font-weight-bold m-0" style="color:#609966;">Daftar Keuntungan Produk</h6>
