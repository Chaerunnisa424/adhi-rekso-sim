            ...
            <li class="nav-item active">
                ...
                <div id="collapsePenjualan" class="collapse" aria-labelledby="headingPenjualan" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ url('/superadmin/penjualan') }}">Daftar Transaksi</a>
                    </div>
                </div>
            </li>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Daftar Pengeluaran</h1>

        <!-- Tombol Tambah Pengeluaran -->
        <a href="{{ route('superadmin.pengeluaran.create') }}"
