...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 text-left">Data Kategori Produk</h1>

        <!-- Tombol untuk buka popup modal -->
        <button class="btn btn-primary btn-sm shadow-sm" data-toggle="modal" data-target="#tambahKategoriModal">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-left">Daftar Kategori Produk</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-left" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                    @forelse ($kategoriproduk as $index => $item)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                ...
                <form id="delete-form-{{ $item->id_kategori }}"
                    action="{{ route('superadmin.kategoriproduk.delete', $item->id_kategori) }}"
                    method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
                    <button type="button" class="btn btn-danger btn-sm" onclick="hapusKategori('{{ $item->id_kategori }}')">
...
<div class="modal fade" id="tambahKategoriModal" tabindex="-1" role="dialog" aria-labelledby="tambahKategoriModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="{{ route('superadmin.kategoriproduk.store') }}" method="POST">
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Text field dengan icon di kiri -->
...
<div class="modal fade" id="editKategoriModal" tabindex="-1" role="dialog" aria-labelledby="editKategoriModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="editForm" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editKategoriModalLabel">Edit Kategori Produk</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
