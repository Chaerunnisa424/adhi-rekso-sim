...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 text-left">Data Supplier</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-left">Daftar Supplier</h6>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Button Delete -->
                                <form id="formHapus-{{ $item->id_supplier }}"
                                    action="{{ route('superadmin.supplier.destroy', $item->id_supplier) }}"
                                    ...
                                    <button type="button"
                                            ...
                                            onclick="hapusSupplier({{ $item->id_supplier }})">
                        ...
                        <!-- MODAL EDIT -->
                        <div class="modal fade" id="modalEdit{{ $item->id_supplier }}" tabindex="-1">
                            <div class="modal-dialog">
                                <form action="{{ route('superadmin.supplier.update', $item->id_supplier) }}" method="POST">
                                    @csrf
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ route('superadmin.supplier.store') }}" method="POST">
            @csrf
            <div class="modal-content">
